package com.webclues.IPPSEngineer.service
...
interface ApiInterface {
    ...
    fun forgetpassword(
        @Field("email") email: String, @Field("user_type") user_type: String
    ): Call<JsonObject>
    ...
    @FormUrlEncoded
    @POST("start_job")
    fun startjob(@Field("job_id") jobid: Int): Call<JsonObject>
    ...
    fun notificationslist(@Field("page_number") pagenumber: Int):
            Call<JsonObject>

    @FormUrlEncoded
    @POST("refresh_token")
    fun refreshtoken(@Field("device_id") device_id: String, @Field("") fcmtoken: String):
            Call<JsonObject>
