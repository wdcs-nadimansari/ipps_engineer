...
import com.webclues.IPPSEngineer.Modelclass.ProfileResponse

import com.webclues.IPPSEngineer.R
import com.webclues.IPPSEngineer.activity.EditProfileActivity
...
class ProfileFragment : Fragment(), View.OnClickListener {
    ...
    private fun SetProfileData(profileResponse: ProfileResponse) {   //Set in user Data
