...
class DeclineFragment : Fragment() {
    ...
    private val mReceiver = object : BroadcastReceiver() {        //Set priority in Decline
...
//            isloading = false
    ...
    fun initView(view: View) {
        ...
        Content.JOB_TYPE = Content.DECLINE_STATUS
    ...
    fun loadFirstpage(            //load first page in Decline
    ...
    private fun loadNextPage(             //load next page in Decline
        pagenumber: Int,
        jobstatus: Int,
        filterpriority: Int,
        engineerid: String
