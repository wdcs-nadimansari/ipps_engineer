...
class JobRequestFragment : Fragment() {
    ...
    private val mReceiver = object : BroadcastReceiver() {      //Setprioritydata in Jobrequest
...
//            isloading = false
    ...
    val mJobAddedReceiver: BroadcastReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            // refersh the list when new job added from notification
    ...
    fun initView(view: View) {
        ...
        Content.JOB_TYPE=Content.JOBREQUEST_STATUS
    ...
    private fun loadNextPage(             //load next page in JobRequest
        pagenumber: Int,
        jobstatus: Int,
        filterpriority: Int,
        engineerid: String
